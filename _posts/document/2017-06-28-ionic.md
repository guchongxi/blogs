...
![Markdown](/assets/img/2017-06-28-ionic/sdk-setting.png)
![Markdown](/assets/img/2017-06-28-ionic/sdk-setting1.png)
![Markdown](/assets/img/2017-06-28-ionic/sdk-setting2.png)
...
初次执行会报错, 说是没有证书什么的(苹果就是麻烦...), 其实ios文件夹已经生成了, 这时候用XCode打开platform/ios/xxx.xcodeproj, 点击根目录, 查看Signing 选择term(注册开发者账号又是另外一回事...) 安装生产证书, 描述性文件..

![ios-signing](/assets/img/2017-06-28-ionic/sdk-setting.png)
